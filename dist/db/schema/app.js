import { pgTable, serial, varchar, text, boolean, integer, real, timestamp, pgEnum, uniqueIndex, check, date, numeric, } from "drizzle-orm/pg-core";
...
export const propertyAmenities = pgTable("property_amenities", {
    ...
    uniquePropertyAmenity: uniqueIndex("unique_property_amenity").on(table.property_id, table.amenity_id),
}));
// ─── 6. Applications ──────────────────────────────
