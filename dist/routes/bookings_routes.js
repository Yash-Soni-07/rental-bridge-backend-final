    ...
    try {
        ...
        const newBooking = await db.transaction(async (tx) => {
            ...
            const overlapping = await tx
                ...
                .from(bookings)
                .where(and(eq(bookings.property_id, property_id), ne(bookings.status, 'cancelled'), lt(bookings.start_date, end_date), gt(bookings.end_date, start_date)))
                .for("update");
...
//# sourceMappingURL=bookings_routes.js.map