...
router.get("/tenant/:tenantId", authenticate, verifyOwnership("tenantId"), async (req, res) => {
...
router.put("/:id", authenticate, async (req, res) => {
    ...
    try {
        ...
        const allowedFields = {}; // Using any here prevents deep type-checking issues with Drizzle's set
        ...
        if (req.body.monthly_income !== undefined)
            allowedFields.monthly_income = req.body.monthly_income;
        if (req.body.employment_status !== undefined)
            allowedFields.employment_status = req.body.employment_status;
        if (req.body.references !== undefined)
            allowedFields.references = req.body.references;
...
//# sourceMappingURL=applications_routes.js.map